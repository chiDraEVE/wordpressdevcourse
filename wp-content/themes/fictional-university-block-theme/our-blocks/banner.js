...
function EditComponent() {
  ...
  return (
    <div className="page-banner">
      <div className="page-banner__bg-image" style={{ backgroundImage: "url('/udemy/wpdev/wp-content/themes/fictional-university-block-theme/images/library-hero.jpg')" }}></div>
