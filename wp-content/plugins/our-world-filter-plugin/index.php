			...
			<div class="wrap">
				...
				<form method="post">
					...
					<label for="plugin_words_to_filter">
						<p>Enter a comma-separated list of words to filter from your site"s content</p>
					</label>
					<div class="word-filter__flex-container">
						<textarea name="plugin_words_to_filter" id="plugin_words_to_filter" placeholder="bad, mean, awful,
						horrible"><?php echo esc_textarea(get_option('plugin_words_to_filter')) ?></textarea>
					</div>
